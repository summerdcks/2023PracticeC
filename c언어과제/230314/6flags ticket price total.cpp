...
int main()
{
	int age, dayNight, number, price, discount, birthYear, birthMonth, birthDay, flag, answer;
	...
	do{
		...
		totalPrice[times] = (int)((float)price*(float)number*discountRate);
